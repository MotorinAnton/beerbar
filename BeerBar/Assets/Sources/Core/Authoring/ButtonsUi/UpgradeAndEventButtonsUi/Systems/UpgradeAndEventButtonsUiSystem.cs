...
namespace Core.Authoring.ButtonsUi.UpgradeAndEventButtonsUi.Systems
{
    ...
    public partial class UpgradeAndEventButtonsUiSystem : SystemBase
    {
        ...
        protected override void OnCreate()
        {
            ...
            _customerContainerPointsQuery = customerContainerPointsBuilder.WithAll<CustomerPointContainer>().Build(this);
        ...
        protected override void OnUpdate()
        {
            ...
            Entities.WithAll<Table, UpgradeAndEvenButtonUiView>().WithAll<EventButtonClicked>().WithNone<Breakdown>().ForEach(
                (in UpgradeAndEvenButtonUiView upgradeAndEvenButtonUiView) =>
                {
                    if (EntityManager.HasComponent<Breakdown>(upgradeAndEvenButtonUiView.ObjectEntity))
                    {
                        var repairArrow =
                            EntityManager.GetComponentObject<RepairMovementArrowView>(upgradeAndEvenButtonUiView.ObjectEntity).Arrow;
                    ...
                    else
                    {
                        ...
                        var movementArrows =
                            EntityManager.GetComponentObject<ClearMovementArrowView>(upgradeAndEvenButtonUiView.ObjectEntity).Arrow;
        ...
        private void UpgradeContainer(Entity entity, UpgradeAndEvenButtonUiView upgradeAndEvenButtonUiView)
        {
            ...
            upgradeAndEvenButtonUiView.UpgradeAndEventButton.gameObject.transform.SetParent(upgradeContainerView.transform);
        ...
        private void UpgradeTable(Entity entity, UpgradeAndEvenButtonUiView upgradeAndEvenButtonUiView)
        {
            ...
            EntityManager.AddComponentObject(upgradeTableEntity, new NavMeshAgentView { Obstacle = upgradeTable.NavMeshObstacle });
        ...
        private bool TrySetName<T>( Entity containerEntity, Entity upgradeContainerEntity, int level , FixedString64Bytes name ) where T : IComponentData 
        {
