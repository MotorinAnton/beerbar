...
namespace Core.Authoring.StoreRatings.Systems
{
    ...
    public partial class StoreRatingSystem : SystemBase
    {
        ...
        protected override void OnCreate()
        {
            ...
            _spillCountQuery = spillCountBuilder.WithAll<Spill>()
                .WithNone<UpgradeAndEvenButtonUiView, BarmanPointContainer, CustomerPointContainer>().Build(this);
            ...
            _spawnPointsContainerQuery =
                spawnPointsContainerBuilder.WithAll<SpawnPointContainer>()
                    .Build(this); // добавить BarmanContainerPoints
                    ...
                    switch (upData.UpType)
                    {
                        case UpType.BottleBeerContainer:
                            ...
                            if (_fridgeQuery.IsEmpty)
                            {
                                ...
                                for (var index = 0; index < spawnPointsContainer.Length; index++)
                                {
                                    ...
                                    AddProductToBuyList(spawnContainerEntity, config, ProductType.BottleBeer,
                                        productToBay);
                        ...
                        case UpType.FishSnackContainer:
                            ...
                            if (_fishSnackQuery.IsEmpty)
                            {
                                for (var index = 0; index < spawnPointsContainer.Length; index++)
                                {
                                    ...
                                    CreateAddContainerButtonUi(config, spawnContainerEntity, upData);
                                    AddProductToBuyList(spawnContainerEntity, config, ProductType.FishSnack,
                                        productToBay);
                                    availableUp.Add(upData);
                                }
                            }
                        ...
                        case UpType.NutsContainer:
                            ...
                            if (_nutsCountQuery.IsEmpty && _nutsQuery.IsEmpty)
                            {
                                ...
                                AddProductToBuyList(spawnPointsNuts[nutsArray.Length], config, ProductType.Nuts,
                                    productToBay);
                                availableUp.Add(upData);
                            }
                        ...
                        case UpType.SpillContainer:
                            ...
                            var sortedSpawnPoints = spawnPointsSpill.OrderBy(entity => entity).ThenBy(entity =>
                                EntityManager.GetBuffer<BarmanContainerPoint>(entity)[0].IndexPoint).ToArray();
                        ...
                        case UpType.AddTable:
                            ...
                            {
                                CreateAddTableButtonUi(config, spawnPointsTable[tableArray.Length], upData,
                                    tableArray.Length);
                                availableUp.Add(upData);
                            }
        ...
        private void CreateAddTableButtonUi(GameConfig config, Entity spawnPointTableEntity, Up upData,
            int indexLevelUpFX)
        {
        ...
        private void SpawnAddBarmanFX( Up upData)
        {
            ...
            spawnPoint.Position.y += BarmanAnimationConstants.AddBarmanFXOffsetY;
        ...
        private void AddProductToBuyList(Entity entity, GameConfig gameConfig, ProductType type,
            ISet<ProductData> productsData)
        {
            ...
            var newProduct =
                gameConfig.ProductConfig.Products.FirstOrDefault(product =>
                    product.ProductType == type && product.Level == 1);
